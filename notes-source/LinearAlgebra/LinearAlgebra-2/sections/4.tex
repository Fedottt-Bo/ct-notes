...
В зависимости от пространства его называют ортогональным ($\R$), либо унитарным ($\C$).
...
\deff{def:} $\mathcal{A} \in End(V)$, $\mathcal{A}$ - о.п.с. и все с.ч $\lambda \geq0$. Тогда $B \in End(V)$, $\mathcal{B}$ - о.п.с, все с.ч. $\mu \geq 0$ называется \deff{арифметическим корнем} из $\mathcal{A}$, если $B^2 = \mathcal{A}$. $B = \sqrt{A}$.
...
\deff{def:} $L_{ij}(\lambda)$ - \deff{элементарная унитреугольная матрица}, это единичная матрица с $\lambda$ в $i$-ой строчке $j$-ом столбце.
